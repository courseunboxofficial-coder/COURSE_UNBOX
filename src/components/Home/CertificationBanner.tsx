...
export default function CertificationBanner() {
  ...
  return (
    ...
    <section className="w-full bg-[#e1f4ff] py-10">
      ...
      <div className="flex gap-4 leading-2">
        ...
        {/* Banner p-3*/}
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-blue-600 via-cyan-500 to-teal-400  md:p-10 shadow-lg p-2.5 sm:p-3.5">
