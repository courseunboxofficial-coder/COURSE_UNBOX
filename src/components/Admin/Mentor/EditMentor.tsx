...
const EditMentor = ({ collapsed, mentor }: { collapsed: boolean, mentor: Mentor }) => {
    ...
    const handleEditData = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (error) {
            ...
            console.log(error);
            toast.error("There is some Error in it  : ");
            setloading(false);

            return
        }

        toast.success("The Data is Edited Succesfully : ");
        console.log(data);
        setloading(false);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 p-8">
                    ...
                    <form onSubmit={handleEditData}>
                        <div className="space-y-5">
                            ...
                            <button className="mt-6 px-10 py-4 rounded-3xl bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition cursor-pointer">
                                {
                                    loading ? "...Loading" : "Save Mentor"
                                }
                            </button>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="text-sm text-gray-500 space-y-1">
                                ...
                                <p>🌐 WORK EXPEIENCE: {formData.work_experience || "N/A"}</p>
